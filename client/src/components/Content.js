...
const Content = ({web3, daiBalance, bibscoinBalance, bibsStakingBalance, setDaiInput, stake, unstake, issueReward}) => (
    <Container style={{backgroundColor: 'white', borderRadius: 20, width: "80vh", padding: 20}}>
        ...
        <br />
        {/* <Row className="justify-content-md-center">
            <Form.Label column lg={1}>BIBS</Form.Label>
            <Col md="auto">
                <Form.Control type="text" placeholder="Amount of BIBS" />
            </Col>
